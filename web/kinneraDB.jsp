...
<html>
    ...
    <%
        try {
            ...
            PreparedStatement ps2 = con.prepareStatement("Select roomno from kinnera where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "kinnera.jsp";</script>
        <%        } else {

            PreparedStatement ps = con.prepareStatement("update kinnera set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "kinnera.jsp";
    </script>
    <%  } else {
    %>
    <script>
    ...
    <%
        ...
        if (rs2.next()) {
            ...
            if (i > 0) {
                ...
                PreparedStatement ps8 = con.prepareStatement("update kinnera set bedstatus=? where bedno=? and floorno=?");
