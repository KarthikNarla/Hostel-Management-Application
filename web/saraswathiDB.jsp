...
<html>
    ...
    <%
        try {
            ...
            PreparedStatement ps2 = con.prepareStatement("Select roomno from saraswathi where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "saraswathi.jsp";</script>
        <%        } else {

            PreparedStatement ps = con.prepareStatement("update saraswathi set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "saraswathi.jsp";
    </script>
    <%  } else {
    %>
    <script>
    ...
    <%
        ...
        if (rs2.next()) {
            ...
            if (i > 0) {
                ...
                PreparedStatement ps8 = con.prepareStatement("update saraswathi set bedstatus=? where bedno=? and floorno=?");
