...
<html>
    <head>
        ...
        <title>kamalanehru</title>
    </head>

    <%
        try {
            String hname = "Kamala Nehru";
            ...
            PreparedStatement ps2 = con.prepareStatement("Select roomno from kamalanehru where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "kamalanehru.jsp";</script>
        <%        } else {

            PreparedStatement ps = con.prepareStatement("update kamalanehru set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "kamalanehru.jsp";
    </script>
    <%  } else {
    %>
    <script>
    ...
    <%
        ...
        if (rs2.next()) {
            ...
            if (i > 0) {
                ...
                PreparedStatement ps8 = con.prepareStatement("update kamalanehru set bedstatus=? where bedno=? and floorno=?");
