...
<html>
    ...
    <%
        try {
            ...
            PreparedStatement ps2 = con.prepareStatement("Select roomno from manjeera where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "manjeera.jsp";</script>
        <%        } else {

            PreparedStatement ps = con.prepareStatement("update manjeera set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "manjeera.jsp";
    </script>
    <%  } else {
    %>
    <script>
    ...
    <%
        ...
        if (rs2.next()) {
            ...
            if (i > 0) {
                ...
                PreparedStatement ps8 = con.prepareStatement("update manjeera set bedstatus=? where bedno=? and floorno=?");
