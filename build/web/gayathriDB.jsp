...
<html>
    ...
    <%
        try {
            ...
            PreparedStatement ps2 = con.prepareStatement("Select roomno from gayathri where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "gayathri.jsp";</script>
        <%        } else {

            PreparedStatement ps = con.prepareStatement("update gayathri set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "gayathri.jsp";
    </script>
    <%  } else {
    %>
    <script>
    ...
    <%
        ...
        if (rs2.next()) {
            ...
            if (i > 0) {
                ...
                PreparedStatement ps8 = con.prepareStatement("update gayathri set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        %>
    <script>
        alert("Student Details with the Roll No. Doesn't exist or The student is a boy.");
        window.location.href = "gayathri.jsp";
    </script>
    <%
            }
