...
<html>
    ...
    <%
        try {
            ...
            PreparedStatement ps2 = con.prepareStatement("Select roomno from krishna where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "krishna.jsp";</script>
        <%        } else {

            PreparedStatement ps = con.prepareStatement("update krishna set bedstatus=? where bedno=? and floorno=?");
    ...
    <script>
        ...
        window.location.href = "krishna.jsp";
    </script>
    <%  } else {
    %>
    <script>
        ...
        if (rs2.next()) {
            ...
            if (i > 0) {
               String Query="update `"+shm+"` set bedstatus=? where bedno=? and floorno=?";
                ...
                PreparedStatement ps8 = con.prepareStatement("update krishna set bedstatus=? where bedno=? and floorno=?");
